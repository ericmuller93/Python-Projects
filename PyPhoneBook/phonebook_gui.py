...
def load_gui(self):
    ...
    #define the listbox with a scrollbar and grid item]
    self.scrollbar1 = Scrollbar(self.master,orient=VERTICAL)
    self.lstList1 = Listbox(self.master,exportselection=0,yscrollcommand=self.scrollbar1.set)
    #below is a listener. Its binding itself to this lstList1 and listening for an event, where it will then call a function
